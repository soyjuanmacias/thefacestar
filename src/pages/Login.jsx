    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Text mb="4" fontSize={{base: '3xl', '2sm': '4xl'}} whiteSpace="nowrap">Bienvenido a</Text>{' '}
            <Highlight
              query="thefacestar"
              styles={{ px: '2', py: '2', rounded: 'md', bg: 'yellow.1000' }}
            >
              thefacestar
            </Highlight>
          </Heading>
          <Heading color="darkgray.900" zIndex={1} fontSize={['md', 'md', 'xl', '2xl']}>
            La red social donde podrás puntuar de manera anónima a cualquier
            persona.
          </Heading>
          <Heading color="brand.500" zIndex={1} fontSize={['md', 'md', 'xl', '2xl']}>
        ...
        >
          ...
          <Box as={'form'} mt={10} display="flex" flex="1" flexDirection="column" justifyContent="space-between">
            <Stack spacing={4}>
              <Input
                placeholder="Nombre"
                bg={'gray.100'}
